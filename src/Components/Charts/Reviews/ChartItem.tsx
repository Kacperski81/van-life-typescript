...
export default function ChartItem({
  ...
  return (
    <div className="grid grid-cols-[3fr_9fr_3fr] items-center py-1 text-base text-[#4D4D4D] sm:grid sm:grid-cols-[2fr_10fr_2fr] lg:grid lg:grid-cols-[60px_400px_100px] h-[24px]">
