...
// type ChartSeries = {
//     //changed this line categories type
//   categories: { name: string; dataKey: string; color: string; }[]
...
//                 className={cx(
//                   getColorClassName(
//                     barCategoryColors.get(category.name) as AvailableChartColorsKeys,
//                     "fill",
//                   ),
...
//               : null}
//             {mergedLineSeries.categories.map((category) =>{ 
//                 console.log("category form line", category)
//             return(
//               <Line
...
//                 // dataKey={category.dataKey}
//                 strokeOpacity={
//                   activeDot || (activeLegend && activeLegend !== category.color)
//                     ? 0.3
//                     : 1
//                 }
//                 activeDot={(props: any) => {
...
//                   if (
//                     (hasOnlyOneValueForKey(data, category.dataKey) &&
//                       !(
//                         activeDot ||
//                         (activeLegend && activeLegend !== category.dataKey)
//                       )) ||
//                     (activeDot?.index === index &&
//                       activeDot?.dataKey === category.dataKey)
//                   ) {
//                     return (
//                       <Dot
//                         key={index}
