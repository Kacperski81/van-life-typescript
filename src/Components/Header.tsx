...
export function Header({ navToggle, handleNavToggle }: HeaderProps) {
    ...
    return (
        ...
        <header 
            className="flex items-center justify-between flex-wrap w-full p-2 bg-background xl:bg-[#e9dbc0]"
        >
            ...
            <div className="ml-4 flex-shrink-0">
                ...
                <NavLink end to="/">
                    ...
                    {/* #VANLIFE */}
                    <div className="w-[100px] lg:w-[120px] flex items-center mb-3">
            ...
            >
                <ul className="px-4 md:px-0 md:grid md:grid-cols-[70px_70px_70px_70px] text-lg md:text-base">
