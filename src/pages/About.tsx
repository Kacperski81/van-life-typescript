...
export function About() {
  ...
  return (
    <section className="mx-auto flex max-w-[700px] flex-col bg-background lg:justify-center xl:bg-[transparent]">
      <div className="mt-2 aspect-[5/2] w-full bg-about-image bg-contain bg-center bg-no-repeat xl:aspect-[0] xl:bg-none">
        {/* <img src="./hero-about.png" alt="van at night" className="w-full" loading="lazy" />  */}
      </div>

      <div className="mx-auto my-4 px-4 text-justify text-white lg:text-black xl:bg-[rgba(233,217,191,0.7)]">
        <div className="p-4">
          ...
          <p className="my-6">
            ...
            travel plans can go off without a hitch. (Hithch costs extra 😉)
          </p>
          <p className="my-6">
