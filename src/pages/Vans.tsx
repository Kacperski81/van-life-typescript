...
export function Vans() {
  ...
  function renderVans(vans: Van[]) {
    const filteredVans = typeFilter
      ...
      : vans;
    return (
      <div className="relative mx-auto w-full lg:max-w-[1030px] xl:aspect-[16/9]">
        <div className="relative mx-auto w-full overflow-hidden">
          <div className="min-[300px] grid p-4 gap-4 min-[300px]:grid-cols-2 lg:grid-cols-3 xl:mx-auto xl:flex xl:w-1/2 xl:max-w-fit">
  ...
  return (
    <div className="mx-auto flex w-full flex-col justify-start self-start bg-background lg:w-11/12 lg:justify-center lg:gap-2 lg:bg-transparent lg:px-3 xl:aspect-[16/9] xl:self-center xl:bg-[rgba(233,217,191,0.3)] xl:py-3 xl:shadow-lg">
      ...
      <Suspense
        fallback={
          <div className="mx-auto flex h-screen w-full justify-center lg:aspect-[16/9] lg:max-w-[1000px] xl:h-fit">
            <p>Loading ...</p>
          </div>
        }
      >
